...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'depth_module.depth_profile',   'default': '1280,720,30', 'description': 'depth stream profile'}, # customized
                           ...
                           {'name': 'pointcloud.enable',            'default': 'true', 'description': ''}, # customized
...
def generate_launch_description():
    ...
    rviz = Node(
        ...
        executable='rviz2',
        arguments=[
            '-d', '../config/rs-hardware-test.rviz'
        ],
    ...
    tf = Node(
            ...
            arguments = ['--x', '0', '--y', '0', '--z', '0', '--yaw', '0', '--pitch', '0', '--roll', '0', '--frame-id', 'world', '--child-frame-id', '']
    ) # customized
