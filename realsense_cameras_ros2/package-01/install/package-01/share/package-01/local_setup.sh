...
: ${AMENT_CURRENT_PREFIX:="/root/ws/assets/package-01/install/package-01"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/package-01/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/package-01/environment/path.sh"
