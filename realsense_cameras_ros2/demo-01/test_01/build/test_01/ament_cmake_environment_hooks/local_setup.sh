...
: ${AMENT_CURRENT_PREFIX:="/root/ws/assets/demo-01/test_01/install/test_01"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/test_01/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/test_01/environment/path.sh"
